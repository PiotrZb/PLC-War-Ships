...
IGuiDialogView
{
	...
	IGuiTextField
	{
		...
		{
			proxy.initProxy(q268435460,268435460)
		}
	}
	IGuiButton
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q486539279,486539279)
		}
	}
	IGuiButton
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q486539280,486539280)
		}
	}
	IGuiGraphicButton
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q486539281,486539281)
		}
	}
	IGuiQmlRectangle
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q671088645,671088645)
		}
	}
	Component.onCompleted:
	{
		proxy.initProxy(q687865863,687865863)
	}
}
